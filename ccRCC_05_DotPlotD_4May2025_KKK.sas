...
* Program: ccRCC_05_DotPlotD_4May2025_KKK.sas
...
********************************************************************************************************************;    
/* 3_LOG */
proc printto log = 'YOUR_PATH_TO_DIRECTORY\3_LOG\ccRCC_05_DotPlotD_4May2025_KKK.txt' new;
run;
/* 4_ADS */
...
* Create a greyscale dot plot
	...
	* Output: None
* ------------------------------------------------------------------------------------------------------------------------------------------------------- *;
proc sgplot data = TLF.ccRCC_EOD dattrmap = MAP;
	...
	ods pdf file = 'YOUR_PATH_TO_DIRECTORY\5_TLF\ccRCC_05_DotPlotD_4May2025_KKK.pdf';
run;
