...
/* 3_LOG */
proc printto log = 'YOUR_PATH_TO_DIRECTORY\3_LOG\LUSC_03_EstimationDelta_OUT_250504_KKK.txt' new;
run;
...
/* 3_LOG */
proc printto log = 'YOUR_PATH_TO_DIRECTORY\3_LOG\LUSC_03_EstimationDelta_WNG_250504_KKK.txt' new;
run;
...
data WNG;
	/* 3_LOG */
	infile 'YOUR_PATH_TO_DIRECTORY\3_LOG\LUSC_03_EstimationDelta_WNG_250504_KKK.txt' truncover;
	input MSG_MDLX1 $200.;
	retain WFG_MDLX1 0;
