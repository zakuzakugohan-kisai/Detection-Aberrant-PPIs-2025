...
********************************************************************************************************************;    
/* 3_LOG */
proc printto log = 'YOUR_PATH_TO_DIRECTORY\3_LOG\ccRCC_05_DotPlotD_1Oct2025_KKK.txt' new;
run;
/* 4_ADS */
...
proc sgplot data = EOD dattrmap = MAP;
	...
	xaxis label = '|d^|';
	yaxis display = none;
	ods pdf file = 'YOUR_PATH_TO_DIRECTORY\5_TLF\ccRCC_05_DotPlotD_1Oct2025_KKK.pdf';
run;
