...
* Program: ccRCC_04_EstimationD_251001_KKK.sas
...
********************************************************************************************************************;
/* 3_LOG */
proc printto log = 'YOUR_PATH_TO_DIRECTORY\3_LOG\ccRCC_04_EstimationD_251001_KKK.txt' new;
run;
/* 4_ADS */
