...
* Program: LUSC_01_CreationProteinLevels_250504_KKK.sas
...
********************************************************************************************************************;
/* 3_LOG */
proc printto log = 'YOUR_PATH_TO_DIRECTORY\3_LOG\LUSC_01_CreationProteinLevels_250504_KKK.txt' new;
run;
/* 4_ADS */
...
* Load files without opening them
	* Input: Group_8Jul2024.xlsx and UnstrandedTPM_9Jul2024.xlsx
