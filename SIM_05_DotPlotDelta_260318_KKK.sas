...
* Program: SIM_05_DotPlotDelta_260318_KKK.sas
* Objective: Creation of dot plots for DLT_HAT
...
********************************************************************************************************************;    
/* 3_LOG */
proc printto log = 'YOUR_PATH_TO_DIRECTORY\3_LOG\SIM_05_DotPlotDelta_260318_KKK.txt' new;
run;
/* 4_ADS */
...
proc sgplot data = POP dattrmap = MAP;
	...
	ods pdf file = 'YOUR_PATH_TO_DIRECTORY\5_TLF\SIM_05_DotPlotDelta_260318_KKK.pdf';
run;
/* Scenario 2 */
data POP;
