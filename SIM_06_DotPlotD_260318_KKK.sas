...
* Program: SIM_06_DotPlotD_260318_KKK.sas
...
********************************************************************************************************************;    
/* 3_LOG */
proc printto log = 'YOUR_PATH_TO_DIRECTORY\3_LOG\SIM_06_DotPlotD_260318_KKK.txt' new;
run;
/* 4_ADS */
...
proc sgplot data = POD dattrmap = MAP;	
	...
	ods pdf file = 'YOUR_PATH_TO_DIRECTORY\5_TLF\SIM_06_DotPlotD_260318_KKK.pdf';
run;
/* Scenario 2 */
data POD;
