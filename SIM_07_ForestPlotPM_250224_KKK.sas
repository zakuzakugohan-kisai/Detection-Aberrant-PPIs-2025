...
* Program: SIM_07_ForestPlotPM_250224_KKK.sas
...
********************************************************************************************************************;    
/* 3_LOG */
proc printto log = 'YOUR_PATH_TO_DIRECTORY\3_LOG\SIM_07_ForestPlotPM_250224_KKK.txt' new;
run;
/* 4_ADS */
...
* ------------------------------------------------------------------------------------------------------------------------------------------------------- *;
data POS;
	input SCENARIO $ BIAS_Q1 BIAS_Q2 BIAS_Q3 DET FE X1 X2 X3 VHAT;
	datalines;
...
* ------------------------------------------------------------------------------------------------------------------------------------------------------- *;
/* Bias */
ods graphics / reset = index imagename = 'Bias_250224_KKK' outputfmt = png;
...
ods graphics / reset = index imagename = 'Detection_250224_KKK' outputfmt = png;
ods listing gpath = 'YOUR_PATH_TO_DIRECTORY\5_TLF';
	ods graphics / height = 10 in width = 10 in;
	proc sgplot data = POS noautolegend;
		format DET 6.1;
...
/* Failed estimation */
ods graphics / reset = index imagename = 'FailedEstimation_250224_KKK' outputfmt = png;
ods listing gpath = 'YOUR_PATH_TO_DIRECTORY\5_TLF';
	ods graphics / height = 10 in width = 10 in;
	proc sgplot data = POS noautolegend;
		format FE 6.1;
		scatter y = SCENARIO x = FE / markerattrs = (symbol = squarefilled);
		scatter y = SCENARIO x = _FE / markerchar = FE x2axis;
		refline 0 100 / axis = x;
		refline 20 40 60 80 / axis = x lineattrs = (pattern = shortdash);
		xaxis offsetmin = 0.01 offsetmax = 0.35 min = 0 max = 100 display = (nolabel);
		x2axis offsetmin = 0.7 display = (noticks nolabel);
...
/* Model X1 */
ods graphics / reset = index imagename = 'ModelX1_250224_KKK' outputfmt = png;
ods listing gpath = 'YOUR_PATH_TO_DIRECTORY\5_TLF';
	ods graphics / height = 10 in width = 10 in;
	proc sgplot data = POS noautolegend;
		format X1 6.1;
...
/* Model X2 */
ods graphics / reset = index imagename = 'ModelX2_250224_KKK' outputfmt = png;
ods listing gpath = 'YOUR_PATH_TO_DIRECTORY\5_TLF';
	ods graphics / height = 10 in width = 10 in;
	proc sgplot data = POS noautolegend;
		format X2 6.1;
...
/* Model X3 */
ods graphics / reset = index imagename = 'ModelX3_250224_KKK' outputfmt = png;
ods listing gpath = 'YOUR_PATH_TO_DIRECTORY\5_TLF';
	ods graphics / height = 10 in width = 10 in;
	proc sgplot data = POS noautolegend;
		format X3 6.1;
...
/* V_HAT */
ods graphics / reset = index imagename = 'VHAT_250224_KKK' outputfmt = png;
ods listing gpath = 'YOUR_PATH_TO_DIRECTORY\5_TLF';
	ods graphics / height = 10 in width = 10 in;
	proc sgplot data = POS noautolegend;
		format VHAT 6.1;
