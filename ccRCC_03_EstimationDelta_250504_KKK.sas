...
* Program: ccRCC_03_EstimationDelta_250504_KKK.sas
...
/* 3_LOG */
proc printto log = 'YOUR_PATH_TO_DIRECTORY\3_LOG\ccRCC_03_EstimationDelta_OUT_250504_KKK.txt' new;
run;

* ------------------------------------------------------------------------------------------------------------------------------------------------------- *;
* Model X1
	* Input: ADS.ccRCC_ADX_&PPI., ADS.ccRCC_ADQ_&PPI., and ADS.ccRCC_MOX_&PPI.
	* Output: MDLX1
* ------------------------------------------------------------------------------------------------------------------------------------------------------- *;
...
/* 3_LOG */
proc printto log = 'YOUR_PATH_TO_DIRECTORY\3_LOG\ccRCC_03_EstimationDelta_WNG_250504_KKK.txt' new;
run;
...
data WNG;
	/* 3_LOG */
	infile 'YOUR_PATH_TO_DIRECTORY\3_LOG\ccRCC_03_EstimationDelta_WNG_250504_KKK.txt' truncover;
	input MSG_MDLX1 $200.;
	retain WFG_MDLX1 0;
...
* Integrate the results from Models X1 and X2
	* Input: ADS.ccRCC_MOX_&PPI., ADS.ccRCC_ADQ_&PPI., MDLX1, and MDLX2
