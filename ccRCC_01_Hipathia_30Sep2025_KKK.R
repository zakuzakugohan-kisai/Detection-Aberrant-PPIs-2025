...
# Program: ccRCC_01_Hipathia_30Sep2025_KKK.R
...
#------------------------------------------------------------------------------#
# File loading
  # Input: 1_TCGA_ccRCC_RNASeq_Group_11Mar2024.xlsx and 1_TCGA_ccRCC_RNASeq_UnstrandedTPM_11Mar2024.xlsx
  # Output: GROUP_01 and TPM_01
#------------------------------------------------------------------------------#
install.packages('readxl')
library(readxl)
GROUP_01 <- read_excel('../1_RAW/1_TCGA_ccRCC_RNASeq_Group_11Mar2024.xlsx')
TPM_01 <- read_excel('../1_RAW/1_TCGA_ccRCC_RNASeq_UnstrandedTPM_11Mar2024.xlsx')
...
CMP_01 <- do_wilcoxon(SGNL_02, GROUP_02, g1 = 'ccRCC', g2 = 'NST', paired = TRUE)
