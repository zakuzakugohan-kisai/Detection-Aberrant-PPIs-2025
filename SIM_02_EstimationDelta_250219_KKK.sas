...
* Program: SIM_02_EstimationDelta_250219_KKK.sas
...
/* 3_LOG */
proc printto log = 'YOUR_PATH_TO_DIRECTORY\3_LOG\SIM_02_EstimationDelta_OUT_250219_KKK.txt' new;
run;
...
/* 3_LOG */
proc printto log = 'YOUR_PATH_TO_DIRECTORY\3_LOG\SIM_02_EstimationDelta_WNG_250219_KKK.txt' new;
run;
...
data WNG;
	/* 3_LOG */
	infile 'YOUR_PATH_TO_DIRECTORY\3_LOG\SIM_02_EstimationDelta_WNG_250219_KKK.txt' truncover;
	input MSG_MDLX1 $200.;
	retain WFG_MDLX1 0;
